    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mb-6">
            <ol class="flex items-center space-x-2 text-sm px-4 py-3 border border-blue-100">
                ...
                <li class="flex items-center text-gray-400">
                    <i class="fas fa-chevron-right text-xs mx-2"></i>
                    <span class="text-gray-700 font-semibold">Editar Usuario</span>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-blue-100 p-6 mb-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800 mb-1">Editar Usuario</h1>
                    <p class="text-gray-600 text-sm">Actualice la información del usuario: {{ $usuario->nombre }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-blue-100 p-6">
            <form action="{{ route('usuarios.update', $usuario->cedula) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            disabled
                        >
                        <p class="text-xs text-gray-400 mt-1">La cédula no se puede modificar</p>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-6">
                    <div class="flex items-center space-x-2 mb-4">
                        ...
                        <h3 class="text-lg font-medium text-gray-800">Cambiar Contraseña</h3>
