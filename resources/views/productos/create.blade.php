    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mb-6">
            <ol class="flex items-center space-x-2 text-sm px-4 py-3 border border-purple-100">
                ...
                <li class="flex items-center text-gray-400">
                    <i class="fas fa-chevron-right text-xs mx-2"></i>
                    <span class="text-gray-700 font-semibold">Agregar Producto</span>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6 mb-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800 mb-1">Agregar Nuevo Producto</h1>
                    <p class="text-gray-600 text-sm">Complete la información del nuevo producto</p>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors @error('detalle') border-red-500 @enderror" 
                              ...
                              rows="3" 
                              required
                              placeholder="Describa las características del producto">{{ old('detalle') }}</textarea>
                    @error('detalle')
                        <div class="text-red-500 text-xs mt-1 flex items-center">
                            <i class="fas fa-exclamation-circle mr-1"></i>
                            {{ $message }}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors @error('tipo') border-red-500 @enderror" 
                                ...
                                <option value="niña" {{ old('tipo') == 'niña' ? 'selected' : '' }}>Niña</option>
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <input type="file" 
                           ...
                           name="imagen" 
                           required>
                    <small class="text-xs text-gray-500 mt-1 block">Formatos: JPEG, PNG, JPG, GIF (Máx. 2MB)</small>
